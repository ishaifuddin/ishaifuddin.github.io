    ...
    return (
        ...
        <>
            ...
            <form onSubmit={filterSubmit}>
                ...
                <input type="url" name="shoplink" required placeholder="https://example.com" /> <br />
                

                <label htmlFor="consumer_secret"> Consumer secret </label>
                <input type="text" name="consumer_secret" required placeholder="consumer secret" /> <br />
                

                <label htmlFor="consumer_key"> Consumer key </label>
                <input type="text" name="consumer_key" required placeholder="consumer key" /> <br />
