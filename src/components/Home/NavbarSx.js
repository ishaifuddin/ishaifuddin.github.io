...
export function NavbarSx() {
  ...
  return (
    <Box
      className={`${menus ? "menus active" : "menus"} ${menuClasses.join(" ")}`}
    >
      <Container size="lg">
        <Header height={60}>
          <Group position="apart" sx={{ height: "100%" }}>
            <RouterLink to={"/"} style={{ width: 150 }}>
              <Image src="/images/logo.png" alt="Shopex Logo" />
            </RouterLink>
      ...
      >
        <RouterLink input ref to={"/"}>
          <Image
            sx={{ marginTop: "-40px", paddingBottom: "10px" }}
            width={150}
        ...
        <ScrollArea sx={{ height: "calc(100vh - 60px)" }} mx="-md">
          ...
          />
          <ScrollLink to={"home"} className={classes.link}>
            Home
          </ScrollLink>
          <ScrollLink to={"features"} className={classes.link}>
            Features
          </ScrollLink>
          <ScrollLink to={"why"} className={classes.link}>
            Why
          </ScrollLink>
          <ScrollLink to={"pricing"} className={classes.link}>
            Pricing
          </ScrollLink>
          <RouterLink to={"/blog"} className={classes.link}>
            Blog
