...
function Products() {
  ...
  var columns = [
    ...
    },
    {
      ...
      field: "firstbuy",
      render: (row) => (
        <div style={{ background: "whitesmoke" }}> {row.firstbuy} </div>
      ),
    },
    {
      title: "lastbuy",
      field: "lastbuy",
      render: (row) => (
        <div style={{ background: "ghostwhite" }}> {row.lastbuy} </div>
      ),
    },
    {
      title: "avg buy gap",
      field: "avg_buy_gap",
      render: (row) => (
        <div style={{ background: "whitesmoke" }}> {row.avg_buy_gap} </div>
      ),
    },
    {
      title: "Total unit",
      field: "totalunit",
      render: (row) => (
        <div style={{ background: "ghostwhite" }}> {row.totalunit} </div>
      ),
    },
    {
      title: "Total spent",
      field: "totalspent",
      render: (row) => (
        <div style={{ background: "whitesmoke" }}> {row.totalspent} </div>
      ),
    },
    {
      title: "Total order",
      field: "totalorder",
      render: (row) => (
        <div style={{ background: "ghostwhite" }}> {row.totalorder} </div>
      ),
    },
  ];
  ...
  var ondisbuy_columns = [
    ...
    },
    {
      ...
      field: "timesbought",
      render: (row) => (
        <div style={{ background: "ghostwhite" }}> {row.timesbought} </div>
      ),
    },
  ];
      ...
      >
        <Grid style={{ display: "inline-flex" }}>
          ...
          <div style={{}}>
            ...
            <p style={{ marginLeft: "10px", marginTop: "0px", color: "white" }}>
              {profile[0].mail}
            </p>
          </div>
        </Grid>
