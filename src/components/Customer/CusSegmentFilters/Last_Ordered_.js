        ...
        <div className="input-filters">
            ...
            { last_order_after && 
                <>  
                    ...
                    <RadioGroup>
                    <label>day <Radio type="radio" name="loitp_unit" value="loitp_day"/></label>  
                    <label>mont <Radio type="radio" name="loitp_unit" value="loitp_month"/></label>  
                    <label>year <Radio type="radio" name="loitp_unit" value="loitp_year"/></label>  
                    </RadioGroup>
                </>
            }
            ...
            { last_order_before && 
                <>
                    ...
                    <RadioGroup>
                    <label>day <Radio type="radio" name="loo_unit" value="loo_day"/></label>  
                    <label>mont <Radio type="radio" name="loo_unit" value="loo_month"/></label>  
                    <label>year <Radio type="radio" name="loo_unit" value="loo_year"/> </label> 
                    </RadioGroup>
                    <strong>Ago</strong> 
                </>
            }
