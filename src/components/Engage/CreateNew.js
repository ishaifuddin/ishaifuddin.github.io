...
function CreateNew() {
  ...
  const saveDesign = () => {
    ...
    emailEditorRef.current.editor.exportHtml((data) => {
      ...
      axios
        .post(
          "https://server.shopex.io/engage/mailtemp.php",
          {
            type: type,
            template_html: html,
  ...
  const getDesign = (design) => {
    ...
    axios
      .post("https://server.shopex.io/engage/mailtemp.php", post_data, {
        withCredentials: true,
      })
      .then(function (response) {
  ...
  useEffect(() => {
    axios
      .get("https://server.shopex.io/engage/mailtemp.php", {
        withCredentials: true,
      })
      .then(function (response) {
    ...
    <Grid className="campaign" container spacing={3}>
      ...
      <Grid item md={12}>
        ...
        <form>
          ...
          />
          <Button
            style={{ background: "rgb(43, 206, 161)", fontWeight: 500 }}
            variant="contained"
            onClick={saveDesign}
          >
            {" "}
        ...
        <div>
          <h6 style={{ color: "#fff" }}> Created automation's : </h6>
          <br />
