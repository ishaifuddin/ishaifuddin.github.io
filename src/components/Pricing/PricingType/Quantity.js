...
function Quantity({target_segment_name,target_segment_id,offername,schedule,osrun,status,pr,for_category,for_product,offer_on_pro_or_cat,qt}) {
        ...
        if(final.length > 0 &&  (cat || prod || all ) ) {
            ...
            if(cat || prod) {
                ...
                for (var i = 0; i < pro_or_cats.length; i++){ 
                    ...
                    for (var j = 0; j < final.length; j++){   
                        ...
                        discount_string = discount_string.concat(available_for).concat("shopex").concat(pro_or_cat_id).concat("shopex").concat(from).concat("shopex").concat(to).concat("shopex").concat(offer).concat("shopex").concat(typee).concat("_break_");
            ...
            if(all) {
                ...
                for (var i = 0; i < final.length; i++){   
                    ...
                    discount_string = discount_string.concat(available_for).concat("shopex").concat(from).concat("shopex").concat(to).concat("shopex").concat(offer).concat("shopex").concat(typee).concat("_break_");
                }
            }
        }
    ...
    return (
        ...
        <>
            ...
            <form onSubmit={formSubmit}>
                ...
                <input style={{height:'40px',width:'300px',fontSize:'16px'}} required={true} name="name" type="text" defaultValue={rulename}/>
                ...
                */}
                ...
                <div>
                    <button className="button add" type="button" onClick={() => addRules(rules.length+1)}>
                ...
                {rules.map((element, index) => (
                    ...
                    <div className="form-inline" key={index} id={"id-"+index}>
                        ...
                        {
                            index ? 
                            <button type="button"  className="button remove" onClick={() => removeRules(index)}>Remove</button> 
                            : null
                        }
