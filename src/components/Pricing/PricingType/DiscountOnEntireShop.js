    ...
    return (
        ...
        <>
            ...
            <form id="dpriceform" onSubmit={formSubmit}>
                ...
                <input style={{ height: '40px', width: '300px', fontSize: '16px' }} required={true}
                    name="name" type="text" defaultValue={offername || ""} />


                <div style={{ margin: '2% 0% 2% 0%', width: '90%' }}>

                    <strong> Select target Segment :: <p>{target_segment_name_}</p> </strong>
                    ...
                    {Customer_segment_options &&
                        ...
                        <Select
                            ...
                            onChange={(e) => { settarget_segment_id(e.value);settarget_segment_name_(e.label); }}
