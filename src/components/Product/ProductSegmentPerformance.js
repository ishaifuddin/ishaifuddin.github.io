...
function ProductSegmentPerformance() {
  ...
  var Product_segs = useSelector(
    (state) => state.product_List_And_Segments.product_segments
  );
  useEffect(() => {
  ...
  if (
    selected_segments.segment_comparison_table_object &&
    selected_segments.segment_comparison_table_object.length > 0
  ) {
    comparison_table = structuredClone(
      selected_segments.segment_comparison_table_object
    );
  }
  ...
  var label = useSelector(
    (state) => state.Product_segments.segment_comparison_chart_base_label
  );
  var label = structuredClone(label);

  ////////////////
  var rev_comparison = useSelector(
    (state) => state.Product_segments.segment_rev_comparison
  );
  var rev_obj = {};
  if (rev_comparison) {
    rev_obj.labels = label;
  ...
  ////////////////
  var order_comparison = useSelector(
    (state) => state.Product_segments.segment_order_comparison
  );
  var order_obj = {};
  if (order_comparison) {
    order_obj.labels = label;
  ...
  ////////////////
  var profit_comparison = useSelector(
    (state) => state.Product_segments.segment_profit_comparison
  );
  var profit_obj = {};
  ...
  ////////////////
  var cus_comparison = useSelector(
    (state) => state.Product_segments.segment_cus_comparison
  );
  var cus_obj = {};
  if (cus_comparison) {
  ...
  ////////////////
  var rcus_comparison = useSelector(
    (state) => state.Product_segments.segment_rcus_comparison
  );
  var rcus_obj = {};
  if (rcus_comparison) {
  ...
  ////////////////
  var unit_comparison = useSelector(
    (state) => state.Product_segments.segment_unit_comparison
  );
  var unit_obj = {};
  if (unit_comparison) {
    unit_obj.labels = label;
