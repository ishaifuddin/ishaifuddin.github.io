        ...
        {recent_sales !== undefined &&
          ...
          recent_sales.map((sale) => (
            <TimelineItem style={{ width: "501px", minHeight: "90px" }}>
                ...
                {sale.order_type === "New Customer" && (
                  <>
                    <p style={{ fontSize: "11px" }}>
                      ...
                      {new Date(sale.atdate).toLocaleString("default", {
                        month: "short",
                      }) +
                        " " +
                        new Date(sale.atdate).getDate()}{" "}
                    </p>
                  </>
                )}
                {sale.order_type !== "New Customer" && (
                  <>
                    <p style={{ fontSize: "11px" }}>
                      {" "}
                      <span style={{ color: "green" }}> Rep : </span>{" "}
                      {new Date(sale.atdate).toLocaleString("default", {
                        month: "short",
                      }) +
                        " " +
              ...
              <TimelineSeparator>
                <TimelineDot
                  style={{ backgroundColor: "ghostwhite", color: "tomato" }}
                >
