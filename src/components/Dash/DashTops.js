        ...
        {tmnew && tmnew.length > 0 && (
          <Card className="dash-card">
            <ThemeProvider theme={defaultMaterialTheme}>
              ...
              <Timeline>
                <Timeline.Item>
                  Total : {tmnew_note !== undefined && tmnew_note[0]}{" "}
                </Timeline.Item>
                <Timeline.Item>
                  Spent : {tmnew_note !== undefined && tmnew_note[1]}{" "}
                </Timeline.Item>
                <Timeline.Item>
                  Avg. Spent : {tmnew_note !== undefined && tmnew_note[2]}{" "}
                </Timeline.Item>
              </Timeline>
            </ThemeProvider>
          </Card>
        ...
        {tmret && tmret.length > 0 && (
          <Card className="dash-card">
            <ThemeProvider theme={defaultMaterialTheme}>
              ...
              <Timeline>
                <Timeline.Item>
                  Total :: {tmret_note !== undefined && tmret_note[0]}{" "}
                </Timeline.Item>
                <Timeline.Item>
                  Spent :: {tmret_note !== undefined && tmret_note[1]}{" "}
                </Timeline.Item>
                <Timeline.Item>
                  Avg. Spent :: {tmret_note !== undefined && tmret_note[2]}{" "}
                </Timeline.Item>
              </Timeline>
            </ThemeProvider>
          </Card>
                ...
                columns={[
                  {
                    title: "Product",
                    field: "proname",
                    render: (row) => <div> {row.proname} </div>,
                  },
                  {
                    title: "Revenue",
                    field: "revenue",
                    render: (row) => <div> {row.revenue} </div>,
                  },
                  {
                    title: "%",
                    field: "percentage",
                    render: (row) => <div> {row.percent} </div>,
                  },
                ]}
                data={tpbr}
