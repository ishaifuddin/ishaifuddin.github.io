        ...
        <div className='wrapper'>
          ...
          <main className='dashboard'>
            ...
            <Routes>
              ...
              <Route exact path="/campaign/compare" element={<OrderListGroupByCamSrc />} />
              ...
              <Route exact path="/Customers/CustomerAndSegemnt" element={<CusListAndSegment />} />
              <Route exact path="/Customers/retention" element={<CusRetention />} />
              <Route exact path="/Customers/retention/selected-city" element={<CusRetentionSC />} />
              <Route exact path="/Customers/profile/:chc" element={<SingleCustomer />} />

              {/* Products */}
              <Route exact path="/Products" element={<ProductListAndSegments />} />
              <Route exact path="/Products/Sales" element={<ProductSalesTable />} />
              <Route exact path="/Products/Performance" element={<ProductPerformance />} />
              <Route exact path="/Products/Specific-city" element={<ProductOneCityPerform />} />
              <Route exact path="/Products/Customer-Segment-based-on-product-purchase" element={<ProductPurchaseCusSeg />} />
              <Route exact path="/Products/Product-segment-performance" element={<ProductSegmentPerformance />} />
              ...
              <Route exact path="/pricing/created" element={<PricingCreatedList />} />
              ...
              <Route exact path="/InsertShopURL/:cus" element={<InsertShopURL />} />
