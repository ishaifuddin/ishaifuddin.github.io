...
var initdata = "";
export const get_init_data = createAsyncThunk("dash/initdata", async (data) => {
  try {
    await axios
      .post("https://server.shopex.io/dashboard/dash_charts_table.php", data, {
...
export const get_recent_sales = createAsyncThunk(
  ...
  async (data) => {
    try {
      await axios
        .post(
          "https://server.shopex.io/dashboard/dash_recent_sales.php",
          data,
          { withCredentials: true }
        )
        .then(
