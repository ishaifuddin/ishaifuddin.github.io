...
var initdata = "";
export const get_cusret_Selcity = createAsyncThunk(
  "cus/RetSelCitydata",
  async (data) => {
    try {
      await axios
        .post(
          "https://server.shopex.io/customers/cus_selected_city_retention.php",
          data,
...
var initdata1 = "";
export const get_cusret_getcity = createAsyncThunk(
  "cus/RetenCitydata",
  async (data) => {
    try {
      await axios
        .post("https://server.shopex.io/customers/cus_citylist.php", data, {
          withCredentials: true,
        })
        .then(
          (response) => {
