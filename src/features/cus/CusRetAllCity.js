...
export const get_cusret_allcity = createAsyncThunk(
  ...
  async (data) => {
    try {
      await axios
        .post(
          "https://server.shopex.io/customers/cus_allcity_retention.php",
          data,
...
export const RetAllCitySlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(get_cusret_allcity.fulfilled, (state, action) => {
        ...
        state.cus_table = action.payload.ctable;
        state.order_table = action.payload.otable;
        state.rev_table = action.payload.rtable;
  ...
  // extraReducers: {
  //     [get_cusret_allcity.pending]: (state, action) => {
  //         state.status = "loading";
  //     },
  //     [get_cusret_allcity.fulfilled]: (state, action) => {

  //         state.status = "success";

  //         if(action.payload.ctable !== 'null') {  //&& action.payload.ctable !== 'null' && action.payload.otable !== 'undefined' && action.payload.otable !== 'null'  && action.payload.rtable !== 'undefined' && action.payload.rtable !== 'null' && action.payload.ochart !== 'undefined' && action.payload.ochart !== 'null' && action.payload.rchart !== 'undefined' && action.payload.cchart !== 'undefined' && action.payload.label !== 'undefined' && action.payload.note !== 'undefined' && action.payload.repeat !== 'undefined') {
  ...
  //     },
  //     [get_cusret_allcity.rejected]: (state, action) => {
  //         state.status = "failed";
  //     },
  // },
});
