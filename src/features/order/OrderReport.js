...
export const get_OrderAndRev_data = createAsyncThunk(
  ...
  async (data) => {
    try {
      await axios
        .post("https://server.shopex.io/orders/order_charts.php", data, {
...
export const get_OrderLocCT_data = createAsyncThunk(
  ...
  async (data) => {
    try {
      await axios
        .post("https://server.shopex.io/orders/order_num_rev_chart.php", data, {
          withCredentials: true,
        })
        .then(
          (response) => {
  ...
  extraReducers: {
    ...
    [get_OrderLocCT_data.fulfilled]: (state, action) => {
      ...
      if (action.payload !== null) {
        ...
        state.label = action.payload.order_number_label
          .replace(/\"/g, "")
          .split(",");
    ...
    [get_OrderAndRev_data.fulfilled]: (state, action) => {
      if (action.payload !== null) {
        ...
        if (action.payload.ton_label) {
          state.to_or_num_label = action.payload.ton_label
            .replace(/\"/g, "")
            .split(",");
          state.to_or_num_data = action.payload.ton_data
            .replace(/\"/g, "")
            .split(",");
        ...
        if (action.payload.toa_label) {
          state.to_or_rev_label = action.payload.toa_label
            .replace(/\"/g, "")
            .split(",");
          state.to_or_rev_data = action.payload.toa_data
            .replace(/\"/g, "")
            .split(",");
        ...
        if (action.payload.non_label) {
          state.new_or_num_label = action.payload.non_label
            .replace(/\"/g, "")
            .split(",");
          state.new_or_num_data = action.payload.non_data
            .replace(/\"/g, "")
            .split(",");
        ...
        if (action.payload.noa_label) {
          state.new_or_rev_label = action.payload.noa_label
            .replace(/\"/g, "")
            .split(",");
          state.new_or_rev_data = action.payload.noa_data
            .replace(/\"/g, "")
            .split(",");
        ...
        if (action.payload.ron_label) {
          state.ret_or_num_label = action.payload.ron_label
            .replace(/\"/g, "")
            .split(",");
          state.ret_or_num_data = action.payload.ron_data
            .replace(/\"/g, "")
            .split(",");
        ...
        if (action.payload.roa_label) {
          state.ret_or_rev_label = action.payload.roa_label
            .replace(/\"/g, "")
            .split(",");
          state.ret_or_rev_data = action.payload.roa_data
            .replace(/\"/g, "")
            .split(",");
        ...
        if (action.payload.pmoa_label) {
          state.paymeth_rev_label = action.payload.pmoa_label
            .replace(/\"/g, "")
            .split(",");
          state.paymeth_rev_data = action.payload.pmoa_data
            .replace(/\"/g, "")
            .split(",");
        }

        if (action.payload.pmon_label) {
          state.paymeth_or_num_label = action.payload.pmon_label
            .replace(/\"/g, "")
            .split(",");
          state.paymeth_or_num_data = action.payload.pmon_data
            .replace(/\"/g, "")
            .split(",");
        }

        if (action.payload.wdoa_label) {
          state.week_day_rev_label = action.payload.wdoa_label
            .replace(/\"/g, "")
            .split(",");
          state.week_day_rev_data = action.payload.wdoa_data
            .replace(/\"/g, "")
            .split(",");
        }

        if (action.payload.wdon_label) {
          state.week_day_or_num_label = action.payload.wdon_label
            .replace(/\"/g, "")
            .split(",");
          state.week_day_or_num_data = action.payload.wdon_data
            .replace(/\"/g, "")
            .split(",");
        }
