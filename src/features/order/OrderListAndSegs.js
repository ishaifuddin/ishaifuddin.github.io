...
export const get_order_List = createAsyncThunk(
  ...
  async (data) => {
    try {
      await axios
        .post("https://server.shopex.io/orders/order_table.php", data, {
...
export const get_order_segs = createAsyncThunk(
  ...
  async (data) => {
    try {
      await axios
        .post("https://server.shopex.io/orders/order_segments.php", data, {
          withCredentials: true,
        })
        .then(
          (response) => {
...
export const get_selseg_List = createAsyncThunk(
  ...
  async (data) => {
    try {
      await axios
        .post("https://server.shopex.io/orders/order_show_segment.php", data, {
          withCredentials: true,
        })
        .then(
          (response) => {
