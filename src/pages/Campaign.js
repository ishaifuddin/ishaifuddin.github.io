      ...
      <Grid container>
        ...
        <Grid item sm={10}>
          <Grid container style={{ margin: "2%" }}>
            <Button
              onClick={(e) => {
                setCampaignSource(true);
                setGroupbysource(false);
                setSingleorders(false);
              }}
              color={campaignSource ? "primary" : "secondary"}
            >
              Add Campaign Source
            </Button>
            ...
            <Button
              onClick={(e) => {
                ...
                setSingleorders(false);
                setCampaignSource(false);
              }}
              color={groupbysource ? "primary" : "secondary"}
            >
              Group by Source
            </Button>
            ...
            <Button
              onClick={(e) => {
                setSingleorders(true);
                setGroupbysource(false);
                setCampaignSource(false);
              }}
              color={singleorders ? "primary" : "secondary"}
            >
              Single Orders
            </Button>
          </Grid>
