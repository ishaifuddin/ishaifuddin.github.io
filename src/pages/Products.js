...
function Products() {
  ...
  var [ProductSegmentPerformance1, setProductSegmentPerformance] =
    useState(false);
  ...
  var product_sections = (section) => {
    ...
    if (section === "ProductListAndSegments1") {
      setProductListAndSegments(true);
    } else if (section === "ProductSalesTable1") {
      setProductSalesTable(true);
    } else if (section === "ProductPerformance1") {
      setProductPerformance(true);
    } else if (section === "ProductOneCityPerform1") {
      setProductOneCityPerform(true);
    } else if (section === "ProductPurchaseCusSeg1") {
      setProductPurchaseCusSeg(true);
    } else if (section === "ProductSegmentPerformance1") {
      setProductSegmentPerformance(true);
    }
  };
  ...
  return (
    <>
      <Grid container style={{ margin: "2%" }}>
        <Button
          value="ProductListAndSegments1"
          onClick={(e) => {
            product_sections(e.target.value);
          }}
          color={ProductListAndSegments1 ? "primary" : "secondary"}
        >
          Product List And Segments
        </Button>

        <Button
          value="ProductSalesTable1"
          onClick={(e) => {
            product_sections(e.target.value);
          }}
          color={ProductSalesTable1 ? "primary" : "secondary"}
        >
          Product Sales
        </Button>

        <Button
          value="ProductPerformance1"
          onClick={(e) => {
            product_sections(e.target.value);
          }}
          color={ProductPerformance1 ? "primary" : "secondary"}
        >
          Product Performance
        </Button>

        <Button
          value="ProductOneCityPerform1"
          onClick={(e) => {
            product_sections(e.target.value);
          }}
          color={ProductOneCityPerform1 ? "primary" : "secondary"}
        >
          Product One City Perform
        </Button>

        <Button
          value="ProductPurchaseCusSeg1"
          onClick={(e) => {
            product_sections(e.target.value);
          }}
          color={ProductPurchaseCusSeg1 ? "primary" : "secondary"}
        >
          Product Purchase Customer Seg
        </Button>

        <Button
          value="ProductSegmentPerformance1"
          onClick={(e) => {
            product_sections(e.target.value);
          }}
          color={ProductSegmentPerformance1 ? "primary" : "secondary"}
        >
