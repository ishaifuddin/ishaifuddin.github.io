...
function Pricing() {
  ...
  return (
      ...
      <>
        ...
        <RadioGroup style={{display: 'inline-block'}} onChange={(e) => {setDiv(e.target.value)}}>
            <Radio checked={div === 'create'} value="create"  name="div"/> Create New Rule
            <Radio checked={div === 'created'} value="created" name="div"/> Available Rule
        </RadioGroup>
